...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    constructor(configService, administradorRepository) {
        super({
    ...
    async validate(payload) {
        ...
        if (!admin) {
            throw new common_1.UnauthorizedException('Token inválido o administrador inactivo');
        }
        return {
            id: admin.id,
...
exports.JwtStrategy = JwtStrategy = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(administrador_entity_1.Administrador)),
