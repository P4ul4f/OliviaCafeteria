...
export async function seedContenidoConfig(dataSource: DataSource) {
  const contenidoConfigRepository = dataSource.getRepository(ContenidoConfig);

  // Datos iniciales para Meriendas Libres
  ...
  // Datos iniciales para Tardes de Té - Promo Olivia
  ...
  // Datos iniciales para Tardes de Té - Promo Básica
